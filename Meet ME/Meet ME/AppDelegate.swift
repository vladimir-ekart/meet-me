...
//  Meet ME
//
//  Created by Vlada on 30.12.2020.
//
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func registerBackgroundTasks() {
        ...
        let backgroundAppRefreshTaskSchedulerIdentifier = "com.meet-me.ekart-gyarab.backgroundAppRefreshIdentifier"
        ...
        BGTaskScheduler.shared.register(forTaskWithIdentifier: backgroundAppRefreshTaskSchedulerIdentifier, using: nil) { (task) in
            ...
            UserController.shared.uploadCalendar { (suc) in
